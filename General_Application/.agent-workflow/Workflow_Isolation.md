...
When running multiple parallel workflows (e.g., frontend + backend simultaneously), use folder-based isolation to prevent Progress.txt bottlenecks and merge conflicts.
...
├── workflows/
│   ├── {workflow-id}/
│   │   ├── Progress.txt        # Workflow-specific log
